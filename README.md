## THIS IS A DIRECT COPY OF THE CODE (https://github.com/vicchi/geojson-rewind) EXCEPT FOR THE CHANGE IN COMPOSER REQUIRE-DEV SO IT IS USABLE IN OTHER PROJECTS
